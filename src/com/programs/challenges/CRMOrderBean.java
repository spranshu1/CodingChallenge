...
public class CRMOrderBean {
	...
	private Map<String, CRMProductBean> OrderProduct;
	...
	public Map<String, CRMProductBean> getOrderProduct(){
		return OrderProduct;
	}
	
	public void setOrderProduct(Map<String, CRMProductBean> orderProduct){
